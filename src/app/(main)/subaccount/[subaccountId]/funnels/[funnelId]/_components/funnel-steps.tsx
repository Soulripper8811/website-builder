...
import { CheckIcon, ExternalLinkIcon, LucideEdit } from "lucide-react";
...
const FunnelSteps = ({ funnelId, subaccountId, funnel, pages }: Props) => {
  ...
  const onDragEnd = (dropResult: DropResult) => {
    ...
    newPageOrder.forEach(async (pages, index) => {
      try {
